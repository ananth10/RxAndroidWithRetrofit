...
import com.ananth.rxandroidwithretrofit.service.GitFollowersService;
...
public class FollowersList extends AppCompatActivity {
    ...
    ArrayList<HashMap<String, String>> mAllFollowersList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRv = (RecyclerView) findViewById(R.id.followers_list);
    ...
    private void getFollowersList() {
        String mUserName = PrefUtils.getData("username", FollowersList.this);
        ...
        GitFollowersService gitFollowService = retrofit.create(GitFollowersService.class);
        Observable<List<Follow>> call = gitFollowService.getGitFollowers(mUserName);
        call.subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe(new Subscriber<List<Follow>>() {
            ...
            public void onCompleted() {
                ...
                if(mAllFollowersList.size()>0) {
                    mRv.setVisibility(View.VISIBLE);
                    mRv.setAdapter(new FollowAdapter(FollowersList.this, mAllFollowersList));
                }else {
